      ...
      <Content page="component">
        <BlockHead>
          <BlockContent>
            ...
            <BlockDes>
              <p className="lead">
                In dots, We included 10 clean and minimalist notification email templates that is ready to use for
            ...
            <EmailWrapper>
              ...
              <EmailFooter>
                <p className="email-copyright-text">
                  Copyright © 2020 dots. All rights reserved. <br /> Template Made By{" "}
            ...
            <EmailWrapper>
              ...
              <EmailBody>
                ...
                <EmailBodyContent className="px-3 px-sm-5 pb-2">
                  ...
                  <p>Click the link below to active your dots account.</p>
                ...
                <EmailBodyContent className="px-3 px-sm-5 pt-4">
                  ...
                  >
                    https://dots.com/account?login_token=dacb711d08a0ee7bda83ce1660918c31e8b43c30
                  </a>
                </EmailBodyContent>
                <EmailBodyContent className="px-3 px-sm-5 pt-4 pb-3 pb-sm-5">
                  ...
                  <p className="email-note">
                    ...
                    please contact us at help@dots.com
                  </p>
                </EmailBodyContent>
              </EmailBody>
              <EmailFooter>
            ...
            <EmailWrapper>
              ...
              <EmailBody>
                <EmailBodyContent className="p-3 p-sm-5">
                  ...
                  <p>We are pleased to have you as a member of dots Family.</p>
                  <p>
